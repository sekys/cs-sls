...
if (isset($_COOKIE['fusion_user'])) {
	// Spojenie
	@$spojenie = mysql_connect("10.0.1.2", "cstrike" , "cslege");
	@$sql_db = mysql_select_db("cstrike");	
	//Parsujeme
	...
	@$result = mysql_query("SELECT user_id FROM fusion_users WHERE user_id='$cookie_1' AND user_password='$cookie_2'");
...
$home_cesta = "/home/cs/public_html/cup/dema/"; // zlozka kde s asukladaju dema
...
{
	global $userdata;
	@mysql_query("INSERT INTO `cstrike`.`web2_logs` (kat, typ, kto, co, komu, int, kedy) VALUES ('-1', '30', ".$userdata[0].", ".SLS::mysql_vstup($_GET['p1']).", NULL, NULL, ".$time.")");
