<? // 	++++++++++++++++++++++++++++++++++++++++++++ Seky`s Liga System ++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	$g_stavky = false;
	$sql_pocet = SLS::Count2("SELECT COUNT(id) as pocet FROM `phpbanlist`.`acp_vyzva` WHERE (ziada !='".SLSUser::$user['clan_id']."' OR prijal !='".SLSUser::$user['clan_id']."') AND prijal IS NOT NULL");
