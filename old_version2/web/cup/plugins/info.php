...
if(!$page) { header("Location: ../index.php"); exit; }	
	echo '
		<div class="cup_body" align="left">
			<img src="/cup/styles/styles_web2/liga-bg.png" alt="logo" border="0" />	
		
			<script type="text/javascript" src="'.SLS::$adresy[0].'javascript.js"></script>
			...
			<div id="tabs" style="color: #999;width:500px;">
				<ul class="tabs_zoznam">
					<li class="ui-state-default ui-corner-top"><a href="#liga">O lige</a></li>
					<li class="ui-state-default ui-corner-top"><a href="#navod">Za&#269;iatok</a></li>
					<li class="ui-state-default ui-corner-top"><a href="#cl">Clan Leader</a></li>
					<li class="ui-state-default ui-corner-top"><a href="#hodnosti">Hodnosti</a></li>
					<li class="ui-state-default ui-corner-top"><a href="#zapas">Z&aacute;pas</a></li>
					<li class="ui-state-default ui-corner-top"><a href="#ceny">Ceny</a></li>
...
'.SLS::get_spravu("Tento projekt vznikol v spolupr&aacute;ci s GeCom s.r.o.<br>&copy; Luk&aacute;&scaron; Seker&aacute;k<br>V&scaron;etke pr&aacute;va vyhraden&eacute;.", 1).'
